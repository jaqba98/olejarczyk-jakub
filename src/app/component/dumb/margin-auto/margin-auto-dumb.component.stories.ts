...
import { MarginAutoDumbComponent } from './margin-auto-dumb.component';
...
const meta: Meta<MarginAutoDumbComponent> = {
  title: 'Component/Dumb/MarginAuto',
  component: MarginAutoDumbComponent,
  decorators: [
    moduleMetadata({
