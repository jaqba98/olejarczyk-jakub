...
import { technologyDataDomainConst } from './technology-data-domain.const';

describe('Technology Data Domain Const', () => {
  it('should return correct data', () => {
    const correctResult: TechnologyStateDomainModel = {
      html: {
        id: 'html',
        name: 'HTML',
        level: 'beginner',
    ...
    expect(technologyDataDomainConst).toEqual(correctResult);
  });
});
